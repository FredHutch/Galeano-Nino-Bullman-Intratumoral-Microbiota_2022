...
# The preprocessing pipeline for Cell Culture samples single-cell GEX data 
ml CellRanger/6.1.1
ml GATK/4.1.3.0-GCCcore-8.3.0-Java-1.8
ml Python
ml Pysam

`raw_data_folder` # the folder containing Cellranger mkfastq output folders for cell culture samples
